...
X = np.load(r"C:\VSD_Sqd_Project\SBD_VER_2.3\model\data_gen\X.npy")
y = np.load(r"C:\VSD_Sqd_Project\SBD_VER_2.3\model\data_gen\y.npy")
...
np.save(r"C:\VSD_Sqd_Project\SBD_VER_2.3\model\data_gen\X_bal_strict.npy", X_strict)
np.save(r"C:\VSD_Sqd_Project\SBD_VER_2.3\model\data_gen\y_bal_strict.npy", y_strict)
...
np.save(r"C:\VSD_Sqd_Project\SBD_VER_2.3\model\data_gen\X_bal_ratio.npy", X_ratio)
np.save(r"C:\VSD_Sqd_Project\SBD_VER_2.3\model\data_gen\y_bal_ratio.npy", y_ratio)
